# 比特币注释
本项目为比特币核心代码的注释项目，收录了中本聪在邮件组提到的所有版本，目的是为了方便开发者阅读和理解早期比特币系统开发的演变路程。
...
| 版本号         | 时间         | 邮件                                                                                                                                                               | 代码下载                                                                                   |
| ----------- | ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| Pre-Release | 2008-11-15 | 未知                                                                                                                                                               | [bitcoin/bitcoin at nov08](https://cdn.nakamotoinstitute.org/code/bitcoin-nov08.rar)   |
...
| 0.1.2       | 2009-01-11 | [\[bitcoin-list\] Bitcoin v0.1.2 now available - Thread \| Satoshi Nakamoto Institute](https://satoshi.nakamotoinstitute.org/emails/bitcoin-list/threads/5/)     | 未知                                                                                     |
