...
Q=k × {G}
$$
点乘是一种运算方式，粗浅的说就是点加的累积，点加就是曲线上两个点，连线之后与椭圆曲线相交叉的点的以 x 轴对称的点。如果两个点是同一个点，那么它们的点加就是这个点的切线与椭圆曲线的交叉点的以 x 轴对称的点。点乘是点加的累积，因此 $Q=k × {G}$ 就是 G 点通过 k 次点加得后得到的一个新点，即 Q 点。
